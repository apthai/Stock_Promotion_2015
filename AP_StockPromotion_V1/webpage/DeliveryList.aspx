<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeliveryList.aspx.cs"
    Inherits="AP_StockPromotion_V1.webpage.DeliveryList" MasterPageFile="~/Master/MasterPage.Master" %>
...
<asp:Content ID="Contenthead" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function RenderAccManagemenr(val) {
            var str;
            str = '<tr>' +
                '    <td class="center">' + val.sapid + '</td>' +
                '    <td>' + val.docno +
                '    </td>' +
                '    <td>' + val.item +
                '    </td>' +
                '    <td class="center">' +
                '        <a data-toggle="modal" data-id="' + val.sapid + '" title="" class="btn btn-xs btn-danger revert" href="#cancellation-modal" onclick="return false;">' +
        ...
        $(document)
            .on('click', '.accmanage-modal', function (e) {
                $.ajax({
                    type: "POST",
                    url: "DeliveryList.aspx/GetAccountingRecorded",
                ...
                bootbox.confirm({
                    ...
                    callback: function (result) {
                        if (result) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "DeliveryList.aspx/ReversingAccountsWBS",
                                data: data,
                                contentType: 'application/json; charset=utf-8',
                                dataType: 'json',
                                async: false,
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseOne">
                        ...
                        &nbsp;รายการส่งมอบสินค้าโปรโมชั่น(WBS)
                    </a>
                </h4>
            </div>
    ...
    <div class="col-sm-12">
        <div class="col-sm-6 left">
            <asp:Button ID="btnPostAccount" runat="server" Text="+ บันทึกบัญชี(WBS)" class="btn btn-white btn-info btn-sm" Font-Bold="true" OnClick="btnPostAccount_Click" />
        </div>
            ...
            <Columns>
                <asp:TemplateField HeaderText="" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="34px">
                    <ItemTemplate>
                        ...
                        <asp:HiddenField ID="grdHdfPRNo" runat="server" Value='<%# Eval("PRNo") %>' />
                        <asp:HiddenField ID="grdHdfPRItem" runat="server" Value='<%# Eval("PRItem") %>' />
                        <asp:HiddenField ID="grdHdfCompanySAPCode" runat="server" Value='<%# Eval("CompanySAPCode") %>' />
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="DelvPromotionId" SortExpression="DelvPromotionId" HeaderText="เลขที่เอกสารส่งมอบ" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                <asp:BoundField DataField="ProjectName" HeaderText="โครงการ" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="130px" />
                <asp:BoundField DataField="WBS_SAP" HeaderText="WBS" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="180px" />
                <asp:BoundField DataField="ItemName" SortExpression="ItemName" HeaderText="สินค้าโปรโมชั่น" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="130px" />
                <asp:BoundField DataField="Amount" SortExpression="Amount" HeaderText="จำนวน" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Right" />
                <asp:BoundField DataField="DelvDate" SortExpression="DelvDate" HeaderText="วันที่ส่งมอบ" DataFormatString="{0:dd/MM/yyyy}" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                <asp:BoundField DataField="CostCenter" SortExpression="CostCenter" HeaderText="Cost Center" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />

                <asp:BoundField DataField="PRNo" SortExpression="PRNo" HeaderText="PRNo" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                <asp:BoundField DataField="PRItem" SortExpression="PRItem" HeaderText="PRItem" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />


                <asp:BoundField DataField="PostRetKey" SortExpression="PostRetKey" HeaderText="SAP Document No." HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                <asp:TemplateField>
                    <ItemTemplate>
