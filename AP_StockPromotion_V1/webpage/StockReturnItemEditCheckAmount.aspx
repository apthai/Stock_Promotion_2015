<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StockReturnItemEditCheckAmount.aspx.cs" 
    Inherits="AP_StockPromotion_V1.webpage.StockReturnItemEditCheckAmount" MasterPageFile="~/Master/MasterPopup.Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <!--
        <asp:TemplateField HeaderText="ขนาด(กว้างxยาวxสูง)">
            <ItemTemplate>
    ...
    <div class="col-sm-12" id="divItemList">
        <asp:GridView ID="grdData" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" class="col-sm-12"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Model" HeaderText="รุ่น" HeaderStyle-HorizontalAlign="Center" />
                <asp:BoundField DataField="Color" HeaderText="สี" HeaderStyle-HorizontalAlign="Center" />                
                <asp:BoundField DataField="Price" HeaderText="ราคา" HeaderStyle-HorizontalAlign="Center" DataFormatString="{0:#,##0.00}" />
                <asp:BoundField DataField="ProduceDate" HeaderText="ProduceDate" HeaderStyle-HorizontalAlign="Center" DataFormatString="{0:dd/MM/yyyy}" />
                ...
                <asp:BoundField DataField="Amt" HeaderText="Amount" HeaderStyle-HorizontalAlign="Center" />
                <asp:TemplateField HeaderText="จำนวน" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <asp:TextBox ID="grdTxtSelectAmount" runat="server" placeholder="0" Width="36px" class="label-caption numericOnly" Text='<%# Eval("RetAmt") %>'></asp:TextBox>
                        ...
                        <asp:HiddenField runat="server" ID="grdHdfRetAmt" Value='<%# Eval("RetAmt") %>' />
                        <asp:HiddenField runat="server" ID="grdHdfUserResponse" Value='<%# Eval("UserResponse") %>' />
