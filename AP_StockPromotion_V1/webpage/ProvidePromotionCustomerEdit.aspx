<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProvidePromotionCustomerEdit.aspx.cs" 
    Inherits="AP_StockPromotion_V1.web.ProvidePromotionCustomerEdit"  MasterPageFile="~/Master/MasterPopup.Master" %>
        ...
        <div id="div1" runat="server" class="col-sm-12" style="display: none;">
            <div class="col-sm-12" style="font-weight: bold;">                
                <div class="col-sm-12" style="font-weight: bold;">
                    ...
                    <div class="col-sm-3">
                        <asp:Label ID="Label6" runat="server" Text="iPhone6 16GB มูลค่า 25,000 บาท"></asp:Label>
                    </div>
                    <div class="col-sm-2" style="text-align: right;">
                        จำนวนคงเหลือ: 
                    </div>
                    <div class="col-sm-1">
                        <asp:Label ID="Label4" runat="server" Text="15"></asp:Label>
                    </div>
                    <div class="col-sm-1">
                        <asp:Label ID="Label11" runat="server" Text="เครื่อง"></asp:Label>
                    </div>
                </div>
            </div>
        ...
        <div id="div2" runat="server" class="col-sm-12" style="display: none;">
            <div class="col-sm-12" style="font-weight: bold;">                
                <div class="col-sm-12" style="font-weight: bold;">
                    ...
                    <div class="col-sm-2">
                        <asp:Label ID="Label1" runat="server" Text="Centro รามอินทรา 109"></asp:Label>
                    </div>
                    <div class="col-sm-2" style="text-align: right;">
                        สินค้าโปรโมชั่น: 
                    </div>
                    <div class="col-sm-3">
                        <asp:Label ID="Label2" runat="server" Text="Gift Voucher Starbuck มูลค่า 500 บาท"></asp:Label>
                    </div>
                    <div class="col-sm-2" style="text-align: right;">
                        จำนวนคงเหลือ: 
                    </div>
                    <div class="col-sm-1">
                        <asp:Label ID="Label3" runat="server" Text="175"></asp:Label>
                    </div>
                    <div class="col-sm-1">
                        <asp:Label ID="Label12" runat="server" Text="ใบ"></asp:Label>
                    </div>
                </div>
            </div>
        ...
        <div id="div3" runat="server" class="col-sm-12" style="display: none;">
            ...
            <div class="col-sm-12" style="font-weight: bold;">                
                <div class="col-sm-12" style="font-weight: bold;">
                    ...
                    <div class="col-sm-2">
                        <asp:Label ID="Label13" runat="server" Text="Centro รามอินทรา 109"></asp:Label>
                    </div>
                    <div class="col-sm-2" style="text-align: right;">
                        สินค้าโปรโมชั่น: 
                    </div>
                    <div class="col-sm-3">
                        <asp:Label ID="Label14" runat="server" Text="สร้อยคอทองคำ หนัก 5 บาท"></asp:Label>
                    </div>
                    <div class="col-sm-2" style="text-align: right;">
                        จำนวนคงเหลือ: 
                    </div>
                    ...
                    <div class="col-sm-1">
                        <asp:Label ID="Label16" runat="server" Text="เส้น"></asp:Label>
                    </div>
                </div>
            </div>
