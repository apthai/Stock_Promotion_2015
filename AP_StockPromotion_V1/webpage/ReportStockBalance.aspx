<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportStockBalance.aspx.cs" 
    Inherits="AP_StockPromotion_V1.webpage.ReportStockBalance"  MasterPageFile="~/Master/MasterPage.Master"  %>
...
<asp:Content ID="Contenthead" ContentPlaceHolderId="head" runat="server">
    ...
    <script type="text/javascript">
        jQuery(function ($) {
            $('#divNavx').html('รายงาน >> รายงานสินค้าโปรโมชั่นคงเหลือในสต๊อกกลาง');
        ...
        <div class="widget-box">
            ...
            <div class="widget-body">
                <div class="widget-main">
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-2 div-caption">เงื่อนไข-แผนกที่ดูแลสินค้า</div>
                        <div class="col-sm-10">
                            <asp:CheckBoxList ID="chkStockType" runat="server" RepeatColumns="3" class="col-sm-8"></asp:CheckBoxList>
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-12 div-caption">
                            <asp:Button id="btnExportReport" runat="server" class="btn btn-white btn-info btn-sm" Text="แสดงรายงานสินค้าโปรโมชั่นคงเหลือในสต๊อกกลาง" OnClick="btnExportReport_Click" />
                        </div>
                    </div>
                </div>
            </div>
