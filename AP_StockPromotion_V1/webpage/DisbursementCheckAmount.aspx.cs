...
{
    public partial class DisbursementCheckAmount : System.Web.UI.Page
    {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (want > 0)
                {
                    ...
                    else
                    {
                        ...
                        hdfTranAmount.Value = (tran + want).ToString();
        ...
        protected void btnOK_Click(object sender, EventArgs e)
        {
            ...
            {
                DataRow[] drItem = dtItemTransferToProject.Select("MasterItemId=" + hdfMasterItemID.Value + " and ReqId=" + hdfReqId.Value);
            ...
            dtRequestList.Select("ItemId=" + hdfMasterItemID.Value + " AND ReqId=" + hdfReqId.Value)[0]["Transfer"] = 0; // เตรียมไปคิดอีกหน้านึง
