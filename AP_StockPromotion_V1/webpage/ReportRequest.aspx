<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportRequest.aspx.cs" 
    Inherits="AP_StockPromotion_V1.webpage.ReportRequest"  MasterPageFile="~/Master/MasterPage.Master"  %>
...
<asp:Content ID="Contenthead" ContentPlaceHolderId="head" runat="server">
    ...
    <script type="text/javascript">
        jQuery(function ($) {
            $('#divNavx').html('รายงาน >> รายงานการเบิกสินค้าโปรโมชั่น');
                ...
                <div class="widget-main">
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-12 div-caption">
                            <asp:Button id="btnExportReport" runat="server" class="btn btn-white btn-info btn-sm" Text="แสดงรายงานการเบิกสินค้าโปรโมชั่น" OnClick="btnExportReport_Click" />
                        </div>
                    </div>
                </div>
            </div>
