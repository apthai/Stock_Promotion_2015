...
{
    public partial class StockDeliveryItemEditCheckAmount : System.Web.UI.Page
    {
        private string[] lstDistinct = { "ReqDocNo", "UnitNo", "Barcode", "ItemName", "Model", "Color", "DimensionWidth", "DimensionLong", "DimensionHeight", "DimensionUnit", "Weight", "WeightUnit", "Price", "ProduceDate", "ExpireDate", "Detail", "Remark" };
        ...
        private void bindData()
        {
            ...
            dtItemList.Columns.Add(new DataColumn("DelvAmt", typeof(int)));
            foreach (DataRow dr in dtItemList.Rows)
            {
                ...
                dr["DelvAmt"] = dt.Compute("COUNT(ItemName)", getConditionGroupItem(dr) + " and MasterItemId = " + hdfMasterItemId.Value + " and Delivery = 'Y'");
            }
        ...
        private string getConditionGroupItem(DataRow dr)
        {
            ...
            cond += " and isnull(ReqDocNo,'') = '" + dr["ReqDocNo"] + "'";
            ...
            if (dr["UnitNo"] == DBNull.Value)
            {
                cond += " and UnitNo is null ";
            }
            else
            {
                cond += " and UnitNo = '" + dr["UnitNo"] + "'";
            }
        ...
        private string getConditionGroupItem(GridViewRow gr)
        {
            ...
            cond += " and isnull(ReqDocNo,'') = '" + ((HiddenField)gr.FindControl("grdHdfReqDocNo")).Value + "'";
            ...
            if (((HiddenField)gr.FindControl("grdHdfUnitNo")).Value + "" == "")
            {
                cond += " and UnitNo is null ";
            }
            else
            {
                cond += " and UnitNo = '" + ((HiddenField)gr.FindControl("grdHdfUnitNo")).Value + "'";
            }
