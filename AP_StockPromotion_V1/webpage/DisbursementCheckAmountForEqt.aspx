<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DisbursementCheckAmountForEqt.aspx.cs" Inherits="AP_StockPromotion_V1.webpage.DisbursementCheckAmountForEqt" MasterPageFile="~/Master/MasterPopup.Master" %>
...
<asp:Content ID="Contenthead" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function sendDataItemAmountList(itemList, reqId) {
            parent.$("#ContentPlaceHolder1_hdfItemIdListEqt").val(itemList);
            parent.$("#ContentPlaceHolder1_hdfReqIdAmountEqt").val(reqId);
            parent.$("#ContentPlaceHolder1_btnCheckItemByAmountEqt").click();
            window.close();
        }
    </script>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-sm-12">
        ...
        <asp:GridView ID="grdRequest" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" class="col-sm-12"
            ...
            <Columns>
                <asp:TemplateField HeaderText="สินค้าโปรโมชั่น" ItemStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Top" FooterStyle-Font-Bold="true" ControlStyle-Font-Size="Large">
                    <ItemTemplate>
                        <asp:Label ID="grdLbItemName" runat="server" Text='<%# Eval("ItemName") + " (" + Eval("ItemUnit") + ") *เทียบเท่าด้วยสินค้าด้านล่าง" %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Caption" ItemStyle-HorizontalAlign="Right" HeaderStyle-Width="100px">
                    <ItemTemplate>
                        ...
                        <asp:Label ID="grdLb3" runat="server" Text="จำนวนเบิก :" ForeColor="Red"></asp:Label><br />
                ...
                <asp:TemplateField HeaderText="DataVal" ItemStyle-HorizontalAlign="Right" HeaderStyle-Width="50px">
                    <ItemTemplate>
                        ...
                        <asp:Label ID="grdLbTransfer" runat="server" ForeColor="Red"></asp:Label><br />
    ...
    <div class="col-sm-12" id="divItemList">
        <asp:GridView ID="grdData" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" class="col-sm-12"
            ...
            <AlternatingRowStyle BackColor="White" />
            <Columns>
                <asp:BoundField DataField="PO_No" HeaderText="PO_No" HeaderStyle-HorizontalAlign="Center" />
                <asp:BoundField DataField="GR_No" HeaderText="GR_No" HeaderStyle-HorizontalAlign="Center" />
                ...
                <asp:BoundField DataField="ExpireDate" DataFormatString="{0:dd/MM/yyyy}" HeaderText="ExpireDate" HeaderStyle-HorizontalAlign="Center" />
                ...
                <asp:BoundField DataField="StockBalance" HeaderText="StockBalance" HeaderStyle-HorizontalAlign="Center" />
                <asp:TemplateField HeaderText="จำนวน" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        ...
                        <asp:HiddenField ID="HiddenField1" runat="server" Value='<%# Eval("ItemName") %>' />
