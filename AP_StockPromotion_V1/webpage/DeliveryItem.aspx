<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeliveryItem.aspx.cs"
    Inherits="AP_StockPromotion_V1.webpage.DeliveryItem" MasterPageFile="~/Master/MasterPage.Master" %>
...
<asp:Content ID="Contenthead" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        jQuery(function ($) {
            $('#divNavx').html('เคลียร์เอกสารส่งมอบ(WBS)');
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="panel-collapse collapse in" id="collapseOne">
                <div class="panel-body">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-3">
                            <asp:TextBox ID="txtWBS" runat="server" placeholder="WBS" class="col-sm-12"></asp:TextBox>
                        </div>
                        ...
                        <div class="col-sm-3">
                            ...
                            <%--<asp:DropDownList ID="ddlConfirmStatus" runat="server" class="col-sm-12 js-example-basic-single js-states form-control hide"></asp:DropDownList>--%>
                        </div>
                        <div class="col-sm-2 div-caption"></div>
                    </div>
    ...
    <%--<div class="col-sm-12">     
        <asp:Button ID="btnDeliveryItemLowPrice" runat="server" Text="ส่งมอบสินค้าโปรโมชั่น" class="btn btn-white btn-info btn-sm" Font-Bold="true" OnClick="btnDeliveryItemLowPrice_Click" />
    </div>--%>

    <div class="col-sm-12">
        <asp:GridView ID="grdData" runat="server" AutoGenerateColumns="False" CellPadding="4" AllowPaging="true" AllowSorting="true"
            ForeColor="#333333" GridLines="None" class="col-sm-12" OnRowCommand="grdData_RowCommand" OnRowDataBound="grdData_RowDataBound" OnPageIndexChanging="grdData_PageIndexChanging" OnSorting="grdData_Sorting">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="DelvPromotionId" SortExpression="DelvPromotionId" HeaderText="เลขที่เอกสารส่งมอบ" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="141px" />
                ...
                <asp:BoundField DataField="WBS" SortExpression="WBS" HeaderText="WBS" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="159px" />
                <asp:BoundField DataField="UnitNo" SortExpression="UnitNo" HeaderText="แปลง/ห้อง" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                ...
                <asp:BoundField DataField="CostCenter" SortExpression="CostCenter" HeaderText="Cost Center" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="123px" />
                <asp:BoundField DataField="StatusText" SortExpression="StatusText" HeaderText="สถานะ" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="123px" />
            </Columns>
