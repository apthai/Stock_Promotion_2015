...
{
    public partial class StockTransferDetail : System.Web.UI.Page
    {
        ...
        {
            DataTable dt = new DataTable("tbTransferDetail");
            initTablePurchaseMockupStructure(ref dt);
            Session["tbTransferDetail"] = dt.Copy();
            enterData();
        }
        ...
        {
            DataTable dt = (DataTable)Session["tbTransferDetail"];
