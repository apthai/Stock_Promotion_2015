<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeliveryItemEdit.aspx.cs"
    Inherits="AP_StockPromotion_V1.webpage.DeliveryItemEdit" MasterPageFile="~/Master/MasterPage.Master"  %>
...
<asp:Content ID="Contenthead" ContentPlaceHolderId="head" runat="server">
    ...
    <script type="text/javascript">
        jQuery(function ($) {
            $('#divNavx').html('ส่งมอบสินค้าโปรโมชั่น(Marketing)');
...
<asp:Content ID="Content2" ContentPlaceHolderId="ContentPlaceHolder1" runat="server">
            ...
            <div class="panel-collapse collapse in" id="collapseOne">
                <div class="panel-body">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-2 div-caption">วันที่เอกสาร</div>
                        <div class="col-sm-3">
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-2 div-caption">เลขที่เอกสาร</div>
                        <div class="col-sm-3">
                            <asp:TextBox ID="txtDocRefNo" runat="server" placeholder="เลขที่เอกสาร" class="col-sm-12"></asp:TextBox>
                        </div>
    ...
    <div class="col-sm-12" style="text-align: right;">
        <asp:Button ID="btnSave" runat="server" Text="บันทึกบัญชี(Marketing)" class="btn btn-white btn-info btn-sm" OnClick="btnSave_Click" />
    </div>
</asp:Content>