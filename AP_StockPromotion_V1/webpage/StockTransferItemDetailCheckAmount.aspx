<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StockTransferItemDetailCheckAmount.aspx.cs"
    Inherits="AP_StockPromotion_V1.webpage.StockTransferItemDetailCheckAmount" MasterPageFile="~/Master/MasterPopup.Master" %>
    ...
    <div class="col-sm-12" id="divItemList">
        <asp:GridView ID="grdData" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" class="col-sm-12"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="ExpireDate" HeaderText="ExpireDate" HeaderStyle-HorizontalAlign="Center" />
