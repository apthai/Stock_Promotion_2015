<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportStockBalanceOnSiteFull.aspx.cs" 
    Inherits="AP_StockPromotion_V1.webpage.ReportStockBalanceOnSiteFull"  MasterPageFile="~/Master/MasterPage.Master"  %>
...
<asp:Content ID="Contenthead" ContentPlaceHolderId="head" runat="server">
    ...
    <script type="text/javascript">
        jQuery(function ($) {
            $('#divNavx').html('รายงาน >> รายงานติดตามสินค้าโปรโมชั่นคงเหลือที่โครงการ');
