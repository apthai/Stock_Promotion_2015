<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeliveryLowPricePostSum.aspx.cs" 
    Inherits="AP_StockPromotion_V1.webpage.DeliveryLowPricePostSum" MasterPageFile="~/Master/MasterPopup.Master" %>
                            ...
                            <div class="col-sm-12">
                                <asp:GridView ID="grdDataSum" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="CostCenter" HeaderText="Internal Order" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                                        ...
                                        <asp:BoundField DataField="Total" HeaderText="Debit" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:#,##0.00}" />
                                        <asp:BoundField DataField="TotalCredit" HeaderText="Credit" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:#,##0.00}" />
