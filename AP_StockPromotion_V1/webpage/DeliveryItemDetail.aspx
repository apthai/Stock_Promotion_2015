<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeliveryItemDetail.aspx.cs" 
    Inherits="AP_StockPromotion_V1.webpage.DeliveryItemDetail"  MasterPageFile="~/Master/MasterPopup.Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-sm-12">
        <asp:GridView ID="grdData" runat="server" AutoGenerateColumns="False" CellPadding="4"
            ...
            <Columns>
                <asp:BoundField DataField="ReqDocNo" HeaderText="เลขที่เอกสารขอเบิก" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                <asp:BoundField DataField="TrListId" HeaderText="เลขที่เอกสารนำจ่าย" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                ...
                <asp:BoundField DataField="ProduceDate" HeaderText="วันผลิต" Visible="false" DataFormatString="{0:dd/MM/yyyy}" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="71px" />
                ...
                <asp:BoundField DataField="Detail" HeaderText="รายละเอียด" Visible="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" />
    ...
    <div class="col-sm-12" style="text-align: right;">
        <asp:Button ID="btnConfirmDelv" runat="server" Text="ยืนยันใบส่งมอบ" class="btn btn-white btn-danger btn-sm" Width="175px" OnClientClick="if (!confirm('คุณต้องการยืนยันใบส่งมอบนี้ ใช่หรือไม่?')) return false;" OnClick="btnConfirmDelv_Click" />
        <asp:Button ID="btnDelDeliv" runat="server" Text="ยกเลิกการตรวจสอบใบส่งมอบ" class="btn btn-white btn-danger btn-sm" Width="175px" OnClientClick="if (!confirm('คุณต้องการยกเลิกการตรวจสอยใบส่งมอบนี้ ใช่หรือไม่?')) return false;"  OnClick="btnDelDeliv_Click" />
    </div>
</asp:Content>
